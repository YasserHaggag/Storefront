...
var orders = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        conn = database_1.default.connect();
                        sql = "INSERT INTO orders (user_id,comments) Values($1,$2) Returning\n             user_id,comments,id";
                        return [4 /*yield*/, conn];
                    case 1:
                        result = (_a.sent()).query(sql, [o.user_id, o.comments]);
                        return [4 /*yield*/, conn];
                    case 2:
                        //close the connection
                        (_a.sent()).release;
    ...
    orders.prototype.getone = function (id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    orders.prototype.updateproduct = function (o) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        conn = database_1.default.connect();
                        sql = "UPDATE orders set user_id=$1,comments=$2 where id=($3) Returning \n             id,user_id,comments";
                        return [4 /*yield*/, conn];
                    case 1:
                        result = (_a.sent()).query(sql, [o.user_id, o.comments, o.id]);
                        return [4 /*yield*/, conn];
                    case 2:
                        //close the connection
                        (_a.sent()).release;
    ...
    orders.prototype.deleteone = function (id) {
        return __awaiter(this, void 0, void 0, function () {
