...
var products = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        conn = database_1.default.connect();
                        sql = "INSERT INTO products (pname,price,pdescription) Values($1,$2,$3) Returning\n             pname,price,pdescription,id";
                        return [4 /*yield*/, conn];
                    case 1:
                        result = (_a.sent()).query(sql, [p.pname, p.price, p.pdescription]);
                        return [4 /*yield*/, conn];
                    case 2:
                        //close the connection
                        (_a.sent()).release;
    ...
    products.prototype.updateproduct = function (p) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        conn = database_1.default.connect();
                        sql = "UPDATE products set pname=$1,price=$2,pdescription=$3 where id=($4) Returning \n             id,pname,price,pdescription";
                        return [4 /*yield*/, conn];
                    case 1:
                        result = (_a.sent()).query(sql, [p.pname, p.price, p.pdescription, p.id]);
                        return [4 /*yield*/, conn];
                    case 2:
                        //close the connection
                        (_a.sent()).release;
    ...
    products.prototype.deleteone = function (id) {
        return __awaiter(this, void 0, void 0, function () {
