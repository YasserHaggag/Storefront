            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        conn = database_1.default.connect();
                        sql = "INSERT INTO users (fullname,telephone,u_address,email,payment_method_id,password) Values($1,$2,$3,$4,$5,$6) Returning\n             id,fullname,telephone,u_address,email,payment_method_id";
                        return [4 /*yield*/, conn];
                    case 1:
                        result = (_a.sent()).query(sql, [u.name, u.telephone, u.address, u.email, u.payment_method, u.password]);
                        return [4 /*yield*/, conn];
                    case 2:
                        //close the connection
                        (_a.sent()).release;
